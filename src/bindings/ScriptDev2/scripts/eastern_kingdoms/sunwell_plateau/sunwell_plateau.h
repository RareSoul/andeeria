...
#define DATA_SATHROVARR_EVENT       28
...
#define DATA_KALECGOS_GATE          28
#define DATA_KALECGOS_FIGHT_GATE_A  29
#define DATA_KALECGOS_FIGHT_GATE_B  30
#define DATA_FELMIST_GATE           31
