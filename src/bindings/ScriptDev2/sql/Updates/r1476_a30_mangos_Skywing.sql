...
(1853301,18533,4,0,100,0, 0,0,0,0, 11,32924,1,1, 1,-98980,0,0, 39,20,0,0,"Luanga the Imprisoner - Mekthorg the Wild - Power of Kran\'aish"),
...
DELETE FROM creature_ai_texts WHERE entry IN (-98980,98979);
INSERT INTO creature_ai_texts (`entry`,`content_default`,`type`,`comment`) VALUES
(-98980,"Skywing! I will free you from your curse over my dead body!",1,'Luanga the Imprisoner - aggro');